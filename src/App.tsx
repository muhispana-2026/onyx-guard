...
${enableSplashScreen ? `// Simple Splash Screen UI
...
${enableRealtimeMonitor ? `// Real-time File System Watcher Thread
...
${enableTestModeBlock ? `    // Test Mode Check
    ...
    if (!status) {
        Sleep(4500); // Allow splash screen progress bar to reach 100% visually
